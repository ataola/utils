...
!(function (t) {
  ...
  function o(t) {
    return (t.getBoundingClientRect && t.getBoundingClientRect()) || null;
  }
  var i = Object.freeze({
    __proto__: null,
    getDOMRect: o,
    getPosition: function (t) {
      var e = o(t),
        r = e.left,
        n = e.top,
        i = document.documentElement || document.body.parentNode;
      return {
        x:
          (window.pageXOffset ||
            window.scrollX ||
            ('number' == typeof i.scrollLeft ? i : document.body).scrollLeft) +
          r,
        y:
          (window.pageYOffset ||
            window.scrollY ||
            ('number' == typeof i.scrollTop ? i : document.body).scrollTop) + n,
      };
    },
  });
  function c(t) {
  ...
  var h = Object.freeze({
    ...
    isArray: u,
    isObject: a,
    isPrototype: function (t) {
      var e = Object.prototype,
        r = t && t.constructor;
      return t === ((c(r) && r.prototype) || e);
    },
    isMap: f,
    isWeakMap: s,
    isSet: l,
    ...
    isScreenXS: function () {
      return o(document.body).width <= 575.98;
    },
    isScreenSM: function () {
      var t = o(document.body).width;
      return t >= 576 && t <= 767.98;
    },
    isScreenMD: function () {
      var t = o(document.body).width;
      return t >= 768 && t <= 991.98;
    },
    isScreenLG: function () {
      var t = o(document.body).width;
      return t >= 992 && t <= 1199.98;
    },
    isScreenXL: function () {
      return o(document.body).width >= 1200;
    },
    isEmpty: function (t) {
      return (
        !t ||
  ...
  !(function (t) {
    var e = (function (t) {
      ...
      return (
        ...
        (g.constructor = v),
        (v.displayName = u(g, a, 'GeneratorFunction')),
        ...
        return g.wrap(function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                if (
                  ((e = n.length > 0 && void 0 !== n[0] ? n[0] : 'test'),
            ...
            switch ((t.prev = t.next)) {
              ...
              case 5:
                (n = window.performance.now()),
                  (o = (n - r).toFixed(2)),
                  console.log('time-consuming: '.concat(o, ' ms'));
              case 8:
              case 'end':
                return t.stop();
            }
  ...
  var S = Object.freeze({
    __proto__: null,
    getQueryParameterByRegExp: function (t, e) {
      var r = new RegExp('[?&]' + e + '=([^&]+).*$'),
        n = t.match(r);
      return null === n ? '' : decodeURIComponent(n[1].replace(/\+/g, ' '));
    },
    getQueryParametersByRegExp: function (t) {
      var e = {};
      return (
